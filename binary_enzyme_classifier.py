...
def parse_args():
    parser = argparse.ArgumentParser(description="Binary enzyme/non-enzyme classification from RAMMER embeddings.")
    parser.add_argument(
        "--input_name",
        required=True,
        type=str,
        help="Input H5 base name under ./RAMMER_embedding (for example: NEW-392).",
    )
    parser.add_argument(
        "--embedding_dir",
    ...
    parser.add_argument(
        "--model_path",
        default="./model/RAMMER_enzyme_classifier_xgb.model",
        type=str,
